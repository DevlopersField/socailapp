...
const FEATURE_GUIDES: Guide[] = [
  {
    ...
    tip: 'Works even without an AI key — it uses smart templates as fallback. But with an AI key, the content is much more specific to your image.',
  },
  {
    id: 'trends',
    ...
    steps: [
      ...
      'Use it in Content Creator or Brain for relevant content',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Select your content type (Case Study, Knowledge, Design, Trend, Promotion)',
      'Answer the 2 questions that appear',
      'Select which platforms to generate for',
      'Click "Generate Content" — get titles, captions, and hashtags',
      'Copy what you need and use it!',
    ],
  },
  {
    id: 'packages',
