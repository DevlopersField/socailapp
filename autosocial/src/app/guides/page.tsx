...
const PLATFORM_GUIDES: Guide[] = [
  {
    ...
    steps: [
      'Step 1: Add your Instagram App Credentials to AutoSocial — Open your app and navigate to Settings (or the Connect page).',
      'Look for the "External App Credentials" or "Developer Keys" section.',
      'Enter your Instagram (Facebook) App ID and App Secret that you got from the Meta Portal.',
      'Click Save.',
      'Step 2: Configure the Meta Portal — Ensure your Meta Dashboard allows your specific local URL.',
      'Go to Use cases → Instagram Graph API → Customize.',
      'Go to Settings → Add Redirect URI: http://localhost:3000/api/auth/instagram/callback',
      'Important: If you are not using HTTPS, make sure you have added a Privacy Policy (like http://localhost:3000) in App Settings → Basic.',
      'Step 3: Connect your Account — Go to the Connect Page.',
      'Click Connect Instagram. Since you\'ve already added your keys in Step 1, the app will now use those specific keys to log you in.',
      'Authenticate with Facebook/Instagram as usual.',
    ],
    tip: 'Once connected, go to your platform detail page to see your posts, analytics, impressions, reach, likes, and engagement rates from Instagram in real-time.',
  },
  {
    id: 'linkedin',
    title: 'LinkedIn',
    ...
    steps: [
      ...
      'Click "Create App"',
      'Fill in: App name, Your company page, Upload any logo',
      'Under Products tab → request "Sign In with LinkedIn" and "Share on LinkedIn"',
      'Go to Auth tab → copy your Client ID and Client Secret',
      'Set Callback URL: {your-app-url}/api/auth/linkedin/callback',
      'Go to AutoSocial Settings → Connected Platforms.',
      'Click "Add LinkedIn Credentials" and paste your Client ID and Secret.',
      'Click "Connect LinkedIn" to authorize your LinkedIn account.',
    ],
    tip: 'LinkedIn tokens expire periodically. You can refresh them automatically by re-connecting.',
  },
  {
    id: 'twitter',
    title: 'Twitter / X',
